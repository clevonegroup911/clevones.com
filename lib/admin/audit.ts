...
export const auditActions = {
  ...
  DOCUMENT_GRANT_CREATED: "DOCUMENT_GRANT_CREATED",
  DOCUMENT_GRANT_REVOKED: "DOCUMENT_GRANT_REVOKED",
  ...
  PAYMENT_CLEVONE_EVENT_CREATED: "PAYMENT_CLEVONE_EVENT_CREATED",
  PAYMENT_RECONCILE_EXECUTED: "PAYMENT_RECONCILE_EXECUTED",
